...
\begin{frame}
    ...
    \end{itemize}
    \onslide<4->{These models do \textbf{not} reveal the computational mechanisms of information processing underlying some cognitive function}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
     ...
     \begin{itemize}
      ...
      \item over-fitting problem \textrightarrow evaluation in terms of generalization performance
     ...
     \begin{itemize}
      ...
      \item challenging to learn a generative model from sensory data and computation of posterior
     \end{itemize}
     \end{itemize}
     }
    \end{itemize}
